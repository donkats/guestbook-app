...
import photoArrow from '../assets/rocasfotoappnieuw.jpg';
  ...
  return (
    <Layout>
      <div className="container has-background-white" id="page-container">
        ...
        <h2 class="title is-2 has-text-centered">Onze appartementen</h2>
        <hr class="hr" />
        ...
        <div className="container">
          ...
          <table class="table is-bordered">
            <tbody>
              <tr><th>Prijs per nacht (niet p.p.)</th><td>€70,-</td></tr>
              <tr><th>Eindschoonmaak</th><td>€70,-</td></tr>
